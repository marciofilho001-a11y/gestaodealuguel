...
function formatStatValue(
  ...
  // Locale fixo pt-BR — o app inteiro formata número em pt-BR (ver format.ts),
  // não faz sentido esse componente seguir o idioma do navegador do usuário.
  const formatted = new Intl.NumberFormat("pt-BR", formatOptions).format(
    value
  );
